...
public class Point2D {
    ...
    /**
     * Gets the distance from this point to the provided point. This uses a costly square root function and should be
    ...
    /**
     * Gets the distance from this point the provided point. This uses a costly square root function and should be
     * avoided whenever possible.
     *
