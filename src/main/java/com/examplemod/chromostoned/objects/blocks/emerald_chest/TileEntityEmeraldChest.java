...
{																		
															//54 is the amount of chest slots
	...
	{
		return this.hasCustomName() ? this.customName : "Emerald Chest";
	}
	...
	{
		return new ContainerEmeraldChest(playerInventory, this, playerIn);
	}

	@Override
	public String getGuiID() 
	{
		return Reference.MOD_ID + ":emerald_chest";
	}
	...
	public void update() 
	{
		if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceLastSync + pos.getX() + pos.getY() + pos.getZ()) % 200 == 0)
        {
            ...
            {
                if (entityplayer.openContainer instanceof ContainerEmeraldChest)
                {
                    if (((ContainerEmeraldChest)entityplayer.openContainer).getChestInventory() == this)
                    {
