...
import static main.java.dp.plugin.maps.EnchantmentData.enchList;
...
class DpEnchant {
    ...
    static boolean run(CommandSender player, Command cmd, String cmdLabel, String[] args) {
        ...
        if (holding.getType() == Material.AIR) {
            ((Player) player).sendMessage("§cError: You must be holding an item to perform this command");
            return false;
        }
